            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 w-80 h-full bg-base-200 text-base-content">
                    <p className="text-4xl text-center font-bold mb-10 mt-4">MARTIAL<span className="text-lime-500">verse</span></p>
                    {
                        isAdmin ?
                            <>
                                <li><NavLink to={'/'} className="text-slate-500 text-lg font-semibold uppercase"><MdClass></MdClass>Manage Classes</NavLink></li>
                            ...
                            <>
                                <li><NavLink to={'/'} className="text-slate-500 text-lg font-semibold uppercase"><MdSelectAll></MdSelectAll>My selected classes</NavLink></li>
